...
% Last Modified by GUIDE v2.5 08-Jul-2014 12:52:03
...
%%%%start: function pbSelect_Callback(hObject, eventdata, handles)
...
%%%%%%start: function pbCrop_Callback(hObject, eventdata, handles)
...
k=num;
if num>5
num = num -5; % In this case, output is character, defined as a number from num 
charset = ['6','7','8','9','0']; 
else 
